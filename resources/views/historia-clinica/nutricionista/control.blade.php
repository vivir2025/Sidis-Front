...
<div class="container-fluid">
    ...
    <div class="card-body">
        ...
        @include('historia-clinica.partials.recordatorio-24h')
        @include('historia-clinica.partials.frecuencia-consumo')
        @include('historia-clinica.partials.plan-seguimiento')
