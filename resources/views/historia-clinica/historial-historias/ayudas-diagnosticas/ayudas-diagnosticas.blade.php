{{-- resources/views/historia-clinica/historial-historias/especial-control/ayudas-diagnosticas.blade.php --}}
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
        ...
        <div class="header-box">
            <div class="header-content">
                ...
                <div class="header-text">
                    ...
                    <p>NIT: 900817959-1</p>
                    <p>FORMATO AYUDAS DIAGNÓSTICAS</p>
        ...
        <fieldset>
            ...
            <table>
                ...
                <tbody>
                    ...
                    @else
                    <tr>
                        <td colspan="3" style="text-align: center;">No hay ayudas diagnósticas registradas</td>
                    </tr>
                    @endif
                </tbody>
            </table>
