...
/**
 * ✅✅✅ CARGAR DATOS PREVIOS (NUEVA FUNCIÓN) ✅✅✅
 */
function cargarDatosPrevios(historiaPrevia) {
    try {
        console.log('🔄 Iniciando carga de datos previos de NUTRICIONISTA PRIMERA VEZ');
        ...
        console.log('✅ Datos previos de NUTRICIONISTA PRIMERA VEZ cargados exitosamente');
...
$(document).ready(function() {
    console.log('🔍 Iniciando script de NUTRICIONISTA PRIMERA VEZ');
    ...
    $('#historiaClinicaForm').on('submit', function(e) {
        ...
        console.log('📤 Iniciando envío del formulario de NUTRICIONISTA PRIMERA VEZ...');
        ...
        // Validar campos requeridos de nutricionista
        if (!$('#motivo').val()) {
            Swal.fire({
                icon: 'error',
                title: 'Error',
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    Swal.fire({
                        icon: 'success',
                        title: '¡Éxito!',
                        text: response.message || 'Historia clínica de nutricionista guardada exitosamente.',
                        timer: 2000,
                        showConfirmButton: false,
                        allowOutsideClick: false
                    }).then(() => {
            ...
            error: function(xhr, status, error) {
                ...
                console.error('❌ Error en AJAX NUTRICIONISTA:', {
                    status: xhr.status,
                    statusText: status,
                    error: error,
            ...
            complete: function() {
                console.log('🏁 Petición AJAX NUTRICIONISTA completada');
                setTimeout(function() {
                    $('#loading_overlay').hide();
                }, 100);
            }
